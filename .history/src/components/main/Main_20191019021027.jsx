    ...
    render(){
        return (
            <div className="main" style={{ height:`${window.innerHeight}px`, backgroundColor: `red`}}>
                <Slide direction="left" in="true" timeout={600} mountOnEnter unmountOnExit>
                    <div elevation={4} style={{width:`50%`, height:`100%`,backgroundColor: `white`}}>
                    
                    <Company />
                    </div>
                </Slide>
                <Slide direction="right" in="true" timeout={600} mountOnEnter unmountOnExit style={{width:`50%`, height:`100%` }}>
