...
export default class Home extends Component {
    ...
    handleEvent = (event) =>{
      var y = event.deltaY;
        if (y > 0) {
            ...
            if (this.state.whellCounter === 0){
                this.setState({
                    whellCounter: this.state.whellCounter
                });
            } 
    ...
    componentDidUpdate(){
        ...
        console.log("actual whellCounter", this.state.showFirst);
        console.log("actual whellCounter", this.state.showSecondary);
        console.log("actual whellCounter", this.state.showThird);
    }
