            ...
            <div className="home" style={{ height:`${window.innerHeight}px`, position:`releative`}} onWheel={(event)=>this.handleEvent(event)}>
                <div className="container" style={{display:`flex`, position:`releative`}}>
                    ...
                    <Slide left when={this.state.showFirst}>
						<div className="side-wrapper m" style={{zIndex: `${this.state.zIndex}`, left: `0`}}>
							<AboutBox />
						</div>
                    </Slide>
                    <Slide right when={this.state.showFirst}>
                        <div className="side-wrapper m" style={{zIndex: `${this.state.zIndex}`,right:`0`}}>
                            <Slide>
                                <div className="item">
                                    <Wellcome />
                                </div>
                    ...
                    <Slide top when={this.state.showSecondary}>
                        <div className="side-wrapper" style={{zIndex: `${this.state.zIndex}`, left: `0`}}>
                            <ConnectionsBox />
                        </div>
                    </Slide>
                    <Slide bottom when={this.state.showSecondary}>
                        <div className="side-wrapper" style={{zIndex: `${this.state.zIndex}`, right:`0`}}>
                    ...
                    <Slide right when={this.state.showThird}>
                        <div className="container t" style={{zIndex: `${this.state.zIndex}`, right:`0`, display:`flex`}}>
                            <Slide right when={this.state.showThird}>
