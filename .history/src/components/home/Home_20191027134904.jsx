        ...
        return (
            <div className="home" style={{ height:`${window.innerHeight}px`, position:`releative`}} onWheel={(event)=>this.handleEvent(event)}>
                <div className="container" style={{display:`flex`, position:`releative`}}>
                    ...
                    <div className="side-wrapper abs">
                    <Slide right when={this.state.showThird}>
                        <div className="side-wrapper abs" style={{zIndex: `${this.state.thirdZIndex}`, left: `0`}}>
                            <SecondAboutBox />
                        </div>
                    </Slide>
                    </div>
                    <Slide right when={this.state.showThird}>
                        <div className="item abs" style={{zIndex: `${this.state.thirdZIndex}`, right:`0`, top:`0`}}>
                            <SecondWellcomeBox />
                        </div>
                    </Slide>
