...
// third
import SecondWellcomeBox from '../boxes/SecondWellcomeBoxomeBox';
        ...
        return (
            <div className="home" style={{ height:`${window.innerHeight}px`, position:`releative`}} onWheel={(event)=>this.handleEvent(event)}>
                <div className="container" style={{display:`flex`, position:`releative`}}>
                    ...
                    <Slide left when={this.state.showThird}>
                        <div className="side-wrapper" style={{zIndex: `${this.state.thirdZIndex}`, left: `0`}}>
                            <SecondAboutBox />
                        </div>
                    </Slide> 
                    <Slide right when={this.state.showThird}>
                        <div className="item" style={{zIndex: `${this.state.thirdZIndex}`, right:`0`}}>
                            <SecondWellcomeBox />
                        </div>
                    </Slide>
                    ...
                    <Slide right when={this.state.showThird}>
                        <div className="container t" style={{zIndex: `${this.state.fourthZIndex}`, right:`0`, display:`flex`}}>
